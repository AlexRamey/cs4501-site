...
docker exec -it spark-master bash -c "bin/spark-submit --master spark://spark-master:7077 --total-executor-cores 2 --executor-memory 512m /tmp/data/spark_script.py"